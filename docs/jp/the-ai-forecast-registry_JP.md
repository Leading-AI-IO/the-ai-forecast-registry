...
ただし、2026年9月16日に追記した009と010の資料は、同日に著者が直接到達したものである。
...
| （2026年9月16日追記）<br>009 | Bernie Sanders／米中首脳会談での先端AI開発停止と超知能禁止の条約交渉への期待／2026-09-15 | ○ | ○ | ○ | △ | 決着前 |
| （2026年9月16日追記）<br>010 | Bill Gates／AIの恩恵の行き先を決める今後12〜18か月の決定／2026-09-15 | ○ | ○ | × | × | 決着前 |
...
2026年9月16日に、次の二行を追記した。

- 009「Bernie Sanders／米中首脳会談での先端AI開発停止と超知能禁止の条約交渉への期待／2026-09-15」
- 010「Bill Gates／AIの恩恵の行き先を決める今後12〜18か月の決定／2026-09-15」

009には、期限（来週）、対象（米中首脳による条約の交渉）、尺度（先端AI開発の一時停止と、超知能の禁止）がある。
しかし述語は「hope ... will negotiate（交渉することを望む）」である。
条約が結ばれれば確認できるが、交渉が行われたかどうかは、会談について何が公表されるかに依存する。
形の上では要求に近いが、決着条件に解釈が残る。

010には、期限（12〜18か月）と対象（AIがどう作られ、資金を得て、展開されるかの決定）がある。
しかし述語は「will determine whether（〜かどうかを決める）」であり、期限が来たときに何を確かめればよいかが書かれていない。

追記後の分布は、次のとおりである。

**第三者が期限到来時に当否を確定できる行 ── 2行（変化なし）**
...
- 004「Gary Marcus／生成AIバブルの崩壊時期の修正」
- 005「Gary Marcus／2025年内のAGI不到来」
- 010「Bill Gates／AIの恩恵の行き先を決める今後12〜18か月の決定」

**定義または述語に解釈が残る行 ── 3行**

- 006「AI Futures Project／2027年3月の超人的コーダー到達」
- 008「Dario Amodei／6〜12か月以内のエージェント群によるインターネット掌握能力」
- 009「Bernie Sanders／米中首脳会談での先端AI開発停止と超知能禁止の条約交渉への期待」

10行のうち、第三者が答えを確認できるのは、引き続き2行である。
...
| ID | 行名（正式名称） | 出典 | 登録時 |
|---|---|---|---|
| 009 | Bernie Sanders／米中首脳会談での先端AI開発停止と超知能禁止の条約交渉への期待／2026-09-15 | 一次 | 決着前 |
| 010 | Bill Gates／AIの恩恵の行き先を決める今後12〜18か月の決定／2026-09-15 | 一次 | 決着前 |

2026年9月16日時点で、台帳は10行になった。
決着後 5行、決着前 5行。
一次 9行、二次 1行。
...
|---|---|
| ID | 009 |
| 行名（正式名称） | Bernie Sanders／米中首脳会談での先端AI開発停止と超知能禁止の条約交渉への期待／2026-09-15 |
| 発言者 | Bernie Sanders（米国上院議員・無所属／バーモント州） |
| 発言日 | 2026-09-15 |
| 発言日の注記 |  |
| 媒体 | 講演（Pro-Human Assembly・ワシントン）。本人事務所サイトに講演原稿（as prepared for delivery）として掲載 |
| 逐語引用 | That is why I very much hope that at their AI summit next week, President Trump will negotiate a comprehensive treaty with President Xi to establish a pause on advanced AI development and a ban on superintelligence. |
| 直前の一文 | It will be humanity’s problem. |
| 直後の一文 | History offers us a powerful lesson. |
| 参考訳 | だからこそ私は、来週のAIサミットで、トランプ大統領が習主席と、先端AI開発の一時停止と超知能の禁止を定める包括的な条約を交渉することを強く望んでいる。 |
| 一次URL | https://www.sanders.senate.gov/press-releases/prepared-remarks-sanders-regulating-ai-is-as-american-as-apple-pie/ |
| 到達証明 | PREPARED REMARKS: Sanders: Regulating AI “is as American as apple pie.”（2026-09-16到達・全文取得） |
| 出典の階層 | 一次 |
| 期限 | あり（「next week」／2026-09-21〜09-27の週。会談の日付は一次資料に記載なし） |
| 対象 | あり（トランプ大統領と習主席による包括的条約の交渉） |
| 尺度 | あり（先端AI開発の一時停止と、超知能の禁止を定める包括的条約） |
| 決着条件 | △（hope that ... will negotiate＝交渉への期待。条約が締結されれば確認できるが、交渉が行われたか否かは会談の公表内容に依存する） |
| 期限の到来 | 未到来 |
| 本人の事後評価 | （なし。期限未到来） |
| 一次資料の記載 | （2026-09-16の登録時点で未収載） |
| 決着前／後 | 決着前 |
| 登録コミット | `c90b814d48feebab1f43f7af81de5f9af07cc10d` |
| 補足 | 講演原稿（as prepared for delivery）であり、当日の実際の発言との照合は未実施。同原稿内に別の言明あり（翌週にGreg Casar下院議員と超知能の開発を恒久的に禁止する法案を提出する予定）。本行は条約の交渉への期待のみ収載 |
...
|---|---|
| ID | 010 |
| 行名（正式名称） | Bill Gates／AIの恩恵の行き先を決める今後12〜18か月の決定／2026-09-15 |
| 発言者 | Bill Gates（Gates Foundation 会長） |
| 発言日 | 2026-09-15 |
| 発言日の注記 | 一次サイトに日付の表示なし。ページのメタ情報（更新日時）は2026-09-15。二次報道（Forbes JAPAN）は米国時間2026年9月15日の発表とする |
| 媒体 | 年次報告書「2026 Goalkeepers Report」の序文（Bill Gates署名） |
| 逐語引用 | I believe that the decisions made in the next 12 to 18 months—about how AI is built, funded, and deployed—will determine whether this technology primarily benefits the people who already have the most or reaches those who have the least. |
| 直前の一文 | Left to the market, AI will be designed by and for the richest people in the world. |
| 直後の一文 | We can harness AI for good. |
| 参考訳 | 私は、AIがどのように作られ、資金を得て、展開されるかについて今後12〜18か月に下される決定が、この技術が主に、すでに最も多くを持つ人々に恩恵をもたらすのか、それとも最も持たざる人々に届くのかを決めると考えている。 |
| 一次URL | https://goalkeepers.gatesfoundation.org/report/2026-report/ |
| 到達証明 | Goalkeepers 2026 Report（2026-09-16到達・全文取得） |
| 出典の階層 | 一次 |
| 期限 | あり（12〜18か月／2027年9月〜2028年3月） |
| 対象 | あり（AIがどう作られ、資金を得て、展開されるかについての決定） |
| 尺度 | なし |
| 決着条件 | なし（will determine whether＝決定が帰結を決めるという言明。期限到来時に確認できる状態が定められていない） |
| 期限の到来 | 未到来 |
| 本人の事後評価 | （なし。期限未到来） |
| 一次資料の記載 | （2026-09-16の登録時点で未収載） |
| 決着前／後 | 決着前 |
| 登録コミット | `c90b814d48feebab1f43f7af81de5f9af07cc10d` |
| 補足 | 直前の一文は、逐語引用の直前に置かれた節見出し。同報告書内に別の期限付き言明あり（「Within three years, if we make the right choices, the most promising AI tools will be broadly deployed ...」）。本行は12〜18か月の言明のみ収載 |
...
「この章の8行は」を「この章の行は」に改めた。
009と010を追記し、行数が8行ではなくなったためである。

この章の行は、同一のデータから次の2ファイルにも出力されている。
...
2026年9月16日に追記した010「Bill Gates／AIの恩恵の行き先を決める今後12〜18か月の決定／2026-09-15」も、一次資料の本文に日付の表示がない。
本書は、ページのメタ情報に記された日付と、二次報道の日付を併記した。
...
上の段落の「最初に期限が来るのは007」は、2026年9月16日の時点で事実ではなくなった。
同日に009「Bernie Sanders／米中首脳会談での先端AI開発停止と超知能禁止の条約交渉への期待／2026-09-15」を追記し、その期限が「next week」、すなわち2026年9月21日から27日の週だからである。
第1版の記述として元の段落は残し、ここに訂正を記す。

最初に期限が来る行は、009である。
本書が自らの命題を最初に試される時点は、2026年12月31日から、この一週間へ前倒しされた。
期限が過ぎたとき、帰結が登録とは別のコミットで追記されるかどうかが、ここで最初に問われる。
